    ...
    <div className='min-h-screen bg-sand-light/30 dark:bg-[#1A1A1A] py-20 px-6 flex items-center justify-center'>
      <div className='max-w-2xl w-full bg-white dark:bg-charcoal border border-charcoal/5 dark:border-linen/5 rounded-3xl p-8 md:p-12 shadow-2xl flex flex-col items-center text-center relative overflow-hidden'>
        ...
        <div className='relative z-10 w-full flex flex-col items-center'>
          ...
          <p className='text-lg text-slate dark:text-linen/80 mb-2'>
            Thank you for choosing Verdant Haven. Your sanctuary awaits.
          </p>
          ...
          <div className='flex flex-col sm:flex-row gap-4 w-full justify-center'>
            ...
            <Link href='/' className='px-8 py-3 rounded-xl border border-charcoal/10 dark:border-linen/10 text-sm font-bold text-charcoal dark:text-linen hover:bg-sand-light dark:hover:bg-charcoal-light transition-colors flex items-center justify-center'>
              Return Home
            </Link>
          </div>
        </div>
