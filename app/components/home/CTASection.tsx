  ...
  return (
    <section className='relative py-28 bg-cover bg-center' style={{ backgroundImage: "url('https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?q=80&w=2000')" }}>
      ...
      <div className='relative z-10 max-w-3xl mx-auto px-6 text-center text-linen flex flex-col items-center gap-6'>
        <span className='text-xs font-bold tracking-widest text-sand uppercase' data-aos='fade-up'>Reserve Your Experience</span>
        <h2 className='font-serif text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-shadow-md' data-aos='fade-up' data-aos-delay='100'>Begin Your Journey to Stillness</h2>
